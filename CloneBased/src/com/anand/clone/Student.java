...
public class Student implements Cloneable {
	...
	/*
	 * // Shallow Cloning public Student clones()throws CloneNotSupportedException {
	 * Student s1=(Student)clone(); return s1; }
	 */
	 
	
	  //deep Copy 
	public Student clones() throws CloneNotSupportedException{ 
		//forInstance Variable 
		Student s1=(Student)clone(); 
		//reference variable
	  s1.address=address.clonning();
	  return s1; 
	  }
